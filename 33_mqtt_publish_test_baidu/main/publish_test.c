...
static esp_err_t mqtt_event_handler(esp_mqtt_event_handle_t event)
{
    ...
    switch (event->event_id) 
    {
        ...
        case MQTT_EVENT_CONNECTED:
            ...
            // 向主题"SW_LED"发生信息，消息为“I am ESP32.”,自动计算有效载荷，qos=1
            esp_mqtt_client_publish(client, "SW_LED", "I am ESP8266", 0, 1, 0);
            // 订阅主题，qos=0
            esp_mqtt_client_subscribe(client, "SW_LED", 0);
            break;
        ...
        case MQTT_EVENT_DATA:
            ...
            {
                if(LED_STATE == 0)
                    esp_mqtt_client_publish(client, "SW_LED", "LED_STATE_ON", 0, 1, 0);
                else
                    esp_mqtt_client_publish(client, "SW_LED", "LED_STATE_OFF", 0, 1, 0);
            }    
            break;
...
static void mqtt_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqtt_cfg = {
        .host = "8c3u7ca.mqtt.iot.bj.baidubce.com",             // MQTT服务端域名/IP地址
        .port = 1883,                                           // MQTT服务器端口
        .client_id = "ESP8266_MQTT",                            // 客户端标识符 (随机使用)
        .username = "8c3u7ca/iot_light_esp8266_01",             // 用户名
        .password = "1aJHPBpgvXJav7OV",                         // 用户密码
